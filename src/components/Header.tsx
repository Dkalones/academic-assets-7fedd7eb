    ...
    <header className="border-b bg-card/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="container flex h-16 items-center justify-between">
        <Link to="/" className="flex items-center gap-3 group">
          {tema.avatarUrl ? (
            <Avatar className="h-10 w-10 shadow-[var(--shadow-card)] group-hover:scale-105 transition-transform ring-2 ring-primary/30">
              <AvatarImage src={tema.avatarUrl} alt="Foto da Profa. Luana" />
